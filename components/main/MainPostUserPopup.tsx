...
function MainUserPopup({ id }: { id: string }) {
  return (
    <div className="rounded-xl p-4 flex flex-col bg-base-100 shadow-lg w-72 sm:w-96 gap-4 ring-2 ring-base-content/20">
      <MainUserLabel id={id} />
      ...
      <div className="inline-flex justify-between items-center">
        <div className="inline-flex gap-2 text-sm sm:text-base">
          <span>199 posts</span>
