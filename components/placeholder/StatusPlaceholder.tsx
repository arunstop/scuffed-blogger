    ...
    >
      ...
      >
        ...
        >
          {status === "error" && (
            <IoMdCloseCircle
              className={`text-[4rem] sm:text-[5rem] animate-twPulse aniamte-infinite ${style.textColor}`}
            />
          )}
          {status === "success" && (
            <FaCheckCircle
          ...
          {status === "loading" && (
            <MdWorkspaces
              className={`animate-twSpin aniamte-infinite text-[4rem] ${style.textColor} sm:text-[5rem]`}
            />
          )}
        </Transition.Child>
